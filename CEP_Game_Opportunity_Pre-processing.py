...
# MAGIC %sql
# MAGIC --select * from curate_standard.BootsUK_GameOpportunities_Boots_CEP_Incr order by rundatetime desc
# MAGIC --ALTER TABLE curate_standard.BootsUK_GameOpportunities_Boots_CEP_Incr ADD columns (Source_create_date string);
# MAGIC --describe curate_standard.BootsUK_GameOpportunities_Boots_CEP_Incr 
...
OutputTableList=[]
dfSchema = StructType([ StructField("customerEligibilityId", StringType(), True),
StructField("contactId", StringType(), True),
StructField("campaignId", StringType(), True),
StructField("opportunityId", StringType(), True),
StructField("reward", StringType(), True),
StructField("rewardType", StringType(), True),
StructField("gamePlayStartDateTime", StringType(), True),
StructField("gamePlayEndDateTime", StringType(), True),
...
dfSchema1 = StructType([ StructField("customerEligibilityId", StringType(), True),
StructField("contactId", StringType(), True),
StructField("campaignId", StringType(), True),
StructField("opportunityId", StringType(), True),
StructField("reward", StringType(), True),
